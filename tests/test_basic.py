...
class TestPlatformUtils:
    ...
    def test_command_exists(self):
        ...
        assert self.platform.command_exists('python') or self.platform.command_exists('python3')
...
class TestWarpNextDNSManager:
    ...
    def setup_method(self):
        ...
        with patch('core.WGCFManager'), \
             patch('core.NextDNSManager'), \
             patch('core.InstallerManager'), \
    ...
    def test_get_status(self):
        ...
        with patch.object(self.manager, 'check_internet_connection', return_value=True), \
             patch.object(self.manager, 'get_warp_ip', return_value='1.2.3.4'), \
             patch.object(self.manager, 'get_dns_servers', return_value=['8.8.8.8']):
...
class TestFileStructure:
    ...
    def test_readme_file(self):
        ...
        assert 'WARP + NextDNS Manager' in readme_content, "README should contain project name"
...
class TestCLICommands:
    ...
    def test_cli_commands_exist(self):
        ...
        expected_commands = [
            ...
            'interactive', 'logs', 'backup', 'uninstall', 'version'
        ]
